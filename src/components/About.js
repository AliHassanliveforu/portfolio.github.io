...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Ali Hassan" },
    { id: 2, title: "Email:", text: "alihassan.liveforu@gmail.com" },
    { id: 3, title: "Phone:", text: "+92 3378027078" },
    { id: 4, title: "Linkedin", text: "https://www.linkedin.com/in/ali-hassan-a19697230/" },
  ]);
  return (
    <div className="about">
        ...
        <div className="row  h-650 alignCenter">
          <div className="col-6">
            <div className="about__img">
              <img src="/images/head.jpeg" alt="man" />
            </div>
          </div>
          <div className="col-6">
